# My Edit
1. I have used Windows Command Prompt while working on this program and things i found:
	
	(a) Using Windows Command Prompt:
		simply using "todo" we can execute the todo app.
	
	(b) Using Windows PowerShell:
		we use "./todo" to execute the todo app.

2. In "report" command as described in this README file, format of the date is given as `dd/mm/yyyy` but in the test case format is `yyyy-mm-dd`. So this could be corrected.

3. I have simply pasted my code in the "todo.py" file in this raw directory. Batch file linking, configurations and all the npm related things is expected when test will be run on other system.
